...
config.read('automation_configurations_booking.cfg')

# Retrieve the values from the 'DEFAULT' section
download_path = config['DEFAULT']['download_path']
from_to_timestrings = config['DEFAULT']['from_to_datestrings']

# Print the retrieved values
print("Download Path:", download_path)
print("From-to Timestrings:", from_to_timestrings)

# Read
# download_path = '/Users/gw/Downloads/'
from_to_timestrings = '20230101 20230630'
output_file_path = download_path + 'tasan to zoho booking import ' + from_to_timestrings + '.xlsx'
...
header_row = ['Journal Number Prefix', 'Journal Number Suffix', 'Journal Date', 'Status', 'Journal Type', 'Journal Transaction Type', 'Reference Number', 'Notes', 'Exchange Rate', 'Tax Name', 'Tax Percentage', 'Tax Type', 'Project Name', 'Debit', 'Credit', 'Account', 'Contact Name', 'Currency', 'Description']
#, '', '', 'Journal Number Prefix', 'Journal Number Suffix', 'Journal Date', 'Status', 'Journal Type', 'Journal Transaction Type', 'Reference Number', 'Notes', 'Exchange Rate', 'Tax Name', 'Tax Percentage', 'Tax Type', 'Project Name', 'Debit', 'Credit', 'Account	Contact Name', 'Currency', 'Description'] # Replace with the actual header values
...
output_values_file_path = download_path + 'tasan to zoho booking import content.xls'
